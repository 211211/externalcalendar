...
import { AccountsService, UserReturnModel, FacilityService } from "../../../services/generated-services";
...
export class AdminComponent implements OnInit, OnDestroy
{
    ...
    public CurrentUser: UserReturnModel = {};
    simpleOption: any[] = [];
    selectedOption = "";
    ...
    {
        accountService.loggedInUser().subscribe(data =>
        {
